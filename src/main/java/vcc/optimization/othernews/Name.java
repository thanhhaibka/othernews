...
public class Name {
	public static String query_getDataToTrain1 = "SELECT  `newsId` FROM  `news`.`news_resource`  LIMIT 0, 10 ;";
	public static String table = "user_log";
	public static String keyspace = "retargetlog";
	public static int portConn = 2395;
	...
	public static String userName = "haint";
	// public static String password = "7qCN7fWp7eUJB4j";
//	 public static String password = "c37GAH4UgMx3yGl";
//	public static String password = "JSOGAXKYTDW5CX3";
	public static String password = "yR2QPCzCbblhkPM";
	...
	public static String usernameCass = "haint";
	public static String passwordCass = "haint";

	public static String[] topics = { "hocduong", "dulich", "game", "cudanmang", "kinhdoanh", "cuocsong", "tvshow",
			"quansu", "anninh", "doisong", "congnghe", "khampha", "suckhoe", "sanphamcongnghe", "batdongsan", "giaitri",
			"xevacongnghe", "anngonkheotay", "quocte", "tamsu", "thethao", "chungkhoan", "phim", "xahoi", "star",
			"esport", "thoitrang", "songkhoe", "phapluat", "handmade" };
	...
	// {0.0,8961.04386207963,0.0,637.0577224194702,0.0,40057.32218685362,0.0,0.0,477.52100959462854,254.61163985024905,1303.6012558717966,1099.2266078574144,1790.4826504114285,0.0,1214.1557725641308,0.0,0.0,3202.831945795826,0.0,0.0,0.0,0.0,2553.954237036942,0.0};
	public static double similar[] = { 0.0, 7082.43296990882, 0.0, 480.19711387301413, 0.0, 31254.185471342174, 0.0,
			0.0, 388.1646738426825, 196.1882224564908, 996.0613197950767, 805.462547855518, 1362.440002589284, 0.0,
			918.9384397714032, 0.0, 0.0, 2398.6699356377962, 0.0, 0.0, 0.0, 0.0, 1993.835492611293, 0.0 };
	...
	public static String table_rows[] = { "congnghe", "cudanmang", "danong360", "doisong", "fun", "giaitri", "hinhsu",
			"infographic", "khampha", "kinhdoanh", "phapluat", "quansu", "quocte", "seagames27", "songkhoe",
			"tetnguyendan", "thegioidoday", "thethao", "truyen", "tuvanphapluat", "vanhoa", "worldcup2014", "xahoi",
			"yeu" };
